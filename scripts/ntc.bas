...
43 LETSTR FLASH = "FLASHs"
44 LETSTR CONSOLE = "CONSOLEs"
45 LETSTR MCUPORT = "COM30"
46 LET MCUBAUD = 9600
47 LETSTR DEVICEPORT = "COM30"
48 LET DEVICEBAUD = 9600
50 REM ======== DO NOT CHANGE ABOVE VARIABLE NAME ========
51 OUT INSTRUCTION = "Welcome to Lavida's mass production line. \n欢迎来到 朗逸 生产线！", "\nFONTCOLOR=BLUE", "\nFONTSIZE=20"
52 REM OUT CONSOLE = "_BARCODE"
53 REM READDATA A = "_BARCODE"
54 REM IF A = 1234567890 THEN 990
55 REM LETSTR AA = "ABC","deF", A, "xx"
56 OUT CONSOLE = "_BARCODELEN=12"
57 GOTO 991
58 OUT CONSOLE = "pass"
59 OUT CONSOLE = "_CURRENTTIME"
60 REM OUT FLASH = "./ihexfiles/lavida_ph0121_1.hex"
61 OUT CONSOLE = "12"
62 OUT CONSOLE = "13"
63 OUT CONSOLE = "14"
...
300 NEXT J
600 REM STOP
610 OUT CONSOLE = "failed and stopped"
900 OUT CONSOLE = "_CURRENTTIME"
910 REM OUT CONSOLE = "_SCAN"
950 DATA -1000, -500, 0, 500, 1000
960 GOTO 1000
990 OUT CONSOLE = "Please scan the barcode first"
991 OUT CONSOLE = "_SCAN"
1000 END
